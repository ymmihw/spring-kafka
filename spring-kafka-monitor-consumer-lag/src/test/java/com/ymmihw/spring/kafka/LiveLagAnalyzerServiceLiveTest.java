...
import com.ymmihw.spring.kafka.service.LagAnalyzerService;
...
@EmbeddedKafka(
    partitions = 1,
    brokerProperties = {"listeners=PLAINTEXT://localhost:9085", "port=9085"})
@EnableKafka
public class LiveLagAnalyzerServiceLiveTest {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(LiveLagAnalyzerServiceLiveTest.class);
  ...
  private static void produce() {
    try {
      ...
      while (count > 0) {
        ...
        LOGGER.info(
            "Message with key = {}, value = {} sent to partition = {}, offset = {}, topic = {}",
            messageKey,
            messageValue,
