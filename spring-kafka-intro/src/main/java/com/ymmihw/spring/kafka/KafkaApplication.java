...
public class KafkaApplication {
  ...
  public static void main(String[] args) throws Exception {
    ...
    /*
     * Sending a Hello World message to topic 'baeldung'. Must be recieved by both listeners with
     * group foo and bar with containerFactory fooKafkaListenerContainerFactory and
    ...
    /*
     * Sending message to a topic with 5 partition, each message to a different partition. But as
     * per listener configuration, only the messages from partition 0 and 3 will be consumed.
     */
    for (int i = 0; i < 5; i++) {
    ...
    /*
     * Sending message to 'filtered' topic. As per listener configuration, all messages with char
     * sequence 'World' will be discarded.
     */
    ...
    /*
     * Sending message to 'greeting' topic. This will send and recieved a java object with the help
     * of greetingKafkaListenerContainerFactory.
     */
  ...
  public static class MessageListener {
    ...
    @KafkaListener(topics = "${message.topic.name}", groupId = "bar",
